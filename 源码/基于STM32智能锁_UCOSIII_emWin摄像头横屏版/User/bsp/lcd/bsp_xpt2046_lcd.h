...
#define             macXPT2046_SPI_GPIO_CLK                         RCC_APB2Periph_GPIOF| RCC_APB2Periph_GPIOB

#define             macXPT2046_SPI_CS_PIN		                        GPIO_Pin_10
#define             macXPT2046_SPI_CS_PORT		                      GPIOF

#define	            macXPT2046_SPI_CLK_PIN	                        GPIO_Pin_13
#define             macXPT2046_SPI_CLK_PORT	                        GPIOB

#define	            macXPT2046_SPI_MOSI_PIN	                        GPIO_Pin_15
#define	            macXPT2046_SPI_MOSI_PORT	                      GPIOB

#define	            macXPT2046_SPI_MISO_PIN	                        GPIO_Pin_14
#define	            macXPT2046_SPI_MISO_PORT	                      GPIOB
