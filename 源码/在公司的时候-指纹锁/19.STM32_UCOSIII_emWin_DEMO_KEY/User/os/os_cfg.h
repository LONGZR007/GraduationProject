...
#define OS_CFG_SCHED_ROUND_ROBIN_EN     0u   //使能/禁用时间片轮转调度
...
#define OS_CFG_MUTEX_EN                 0u   //使能或禁用互斥信号量
#define OS_CFG_MUTEX_DEL_EN             0u   //使能或禁用 OSMutexDel() 函数    
#define OS_CFG_MUTEX_PEND_ABORT_EN      0u   //使能或禁用 OSMutexPendAbort() 函数 
...
#define OS_CFG_TIME_DLY_RESUME_EN       1u   //使能/禁用 OSTimeDlyResume() 函数
                                             ...
                                             /* ------------------------- TIMER MANAGEMENT -------------------------- */
#define OS_CFG_TMR_EN                   0u   //使能/禁用软件定时器
#define OS_CFG_TMR_DEL_EN               0u   //使能/禁用 OSTmrDel() 函数
