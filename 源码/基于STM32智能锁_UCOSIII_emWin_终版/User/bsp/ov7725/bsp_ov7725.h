...
#define      macOV7725_CS_GPIO_CLK                       RCC_APB2Periph_GPIOB
#define      macOV7725_CS_GPIO_PORT                      GPIOB
#define      macOV7725_CS_GPIO_PIN                       GPIO_Pin_6

#define      macOV7725_WRST_SCK_APBxClock_FUN            RCC_APB2PeriphClockCmd
#define      macOV7725_WRST_GPIO_CLK                     RCC_APB2Periph_GPIOB
#define      macOV7725_WRST_GPIO_PORT                    GPIOB
#define      macOV7725_WRST_GPIO_PIN                     GPIO_Pin_5
...
#define      macOV7725_RRST_GPIO_PIN                     GPIO_Pin_12

#define      macOV7725_RCLK_SCK_APBxClock_FUN            RCC_APB2PeriphClockCmd
#define      macOV7725_RCLK_GPIO_CLK                     RCC_APB2Periph_GPIOA
#define      macOV7725_RCLK_GPIO_PORT                    GPIOA
#define      macOV7725_RCLK_GPIO_PIN                     GPIO_Pin_15
...
#define      macOV7725_DATA_GPIO_CLK                     RCC_APB2Periph_GPIOF
...
#define READ_FIFO_PIXEL(RGB565)   	do{\
	                                  RGB565=0;\
	                                  FIFO_RCLK_L();\
	                                  RGB565 = (GPIOF->IDR<<8) & 0xff00;\
	                                  FIFO_RCLK_H();\
                                    FIFO_RCLK_L();\
	                                  RGB565 |= (GPIOF->IDR) & 0x00ff;\
	                                  FIFO_RCLK_H();\
                                    }while(0)
