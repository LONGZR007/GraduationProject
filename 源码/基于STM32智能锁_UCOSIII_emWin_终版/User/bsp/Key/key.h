...
#define Bell_OUT_INT_GPIO_PORT         GPIOG
#define Bell_OUT_INT_GPIO_CLK          (RCC_APB2Periph_GPIOG|RCC_APB2Periph_AFIO)
#define Bell_OUT_INT_GPIO_PIN          GPIO_Pin_2
#define Bell_OUT_INT_EXTI_PORTSOURCE   GPIO_PortSourceGPIOG
#define Bell_OUT_INT_EXTI_PINSOURCE    GPIO_PinSource2
#define Bell_OUT_INT_EXTI_LINE         EXTI_Line2
...
#define Bell_OUT_INT_EXTI_IRQ          EXTI2_IRQn
#define Bell_OUT_IRQHandler            EXTI2_IRQHandler
